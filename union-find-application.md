...
![Percolation example:  model a percolation system using an n-by-n grid of sites](.gitbook/assets/image%20%2828%29.png)
...
![Algorithm example: implement with virtual sites ](.gitbook/assets/image%20%2827%29.png)
