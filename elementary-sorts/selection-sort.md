...
![Problem example: unordered sequence](../.gitbook/assets/image%20%2833%29.png)
...
![Invariant example: unchangeable left side, pointer always need to point to the smallest of remain](../.gitbook/assets/image%20%2824%29.png)
...
![Geometric argument example: order of growth = N^/2 + ~](../.gitbook/assets/image%20%2811%29.png)
