...
![Problem example: unordered sequence](../.gitbook/assets/image%20%2830%29.png)
...
![Invariant example: unchangeable left side, pointer always need to point to the smallest of remain](../.gitbook/assets/image%20%2821%29.png)
...
![Geometric argument example: order of growth = N^/2 + ~](../.gitbook/assets/image%20%2810%29.png)
